                ...
                for(int i = 0; i < listaJuntasXSpool.Count; i++)
                {
                    ...
                    foreach (Sam3_Soldadura_Get_DetalleJunta_Result item in detalle)
                    {
                        DetalleDatosJsonSoldadura detalleDatos = new DetalleDatosJsonSoldadura
                        {
                            ...
                            Raiz = GenerarRaizJson((List<Sam3_Soldadura_Get_DetalleSoldadorProceso_Result>)CapturaSoldaduraBD.Instance.DetallaRaizAdicional(int.Parse(item.JuntaSoldaduraID.ToString()), usuario), item.JuntaSpoolID),
                            RaizDetalle = GenerarRaizJson((List<Sam3_Soldadura_Get_DetalleSoldadorProceso_Result>)CapturaSoldaduraBD.Instance.DetallaRaizAdicional(int.Parse(item.JuntaSoldaduraID.ToString()), usuario), item.JuntaSpoolID),
                            RaizInicial = GenerarRaizJson((List<Sam3_Soldadura_Get_DetalleSoldadorProceso_Result>)CapturaSoldaduraBD.Instance.DetallaRaizAdicional(int.Parse(item.JuntaSoldaduraID.ToString()), usuario), item.JuntaSpoolID),
                            Relleno = GenerarRaizJson((List<Sam3_Soldadura_Get_DetalleSoldadorProceso_Result>)CapturaSoldaduraBD.Instance.DetallaRellenoAdicional(int.Parse(item.JuntaSoldaduraID.ToString()), usuario), item.JuntaSpoolID),
                            RellenoDetalle = GenerarRaizJson((List<Sam3_Soldadura_Get_DetalleSoldadorProceso_Result>)CapturaSoldaduraBD.Instance.DetallaRellenoAdicional(int.Parse(item.JuntaSoldaduraID.ToString()), usuario), item.JuntaSpoolID),
                            RellenoInicial = GenerarRaizJson((List<Sam3_Soldadura_Get_DetalleSoldadorProceso_Result>)CapturaSoldaduraBD.Instance.DetallaRellenoAdicional(int.Parse(item.JuntaSoldaduraID.ToString()), usuario), item.JuntaSpoolID),
