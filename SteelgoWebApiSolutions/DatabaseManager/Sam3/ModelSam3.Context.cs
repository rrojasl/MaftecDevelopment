...
namespace DatabaseManager.Sam3
{
    ...
    public partial class SamContext : DbContext
    {
        ...
        public virtual DbSet<Sam3_Rel_ProveedorTipoPrueba> Sam3_Rel_ProveedorTipoPrueba { get; set; }
        ...
        public virtual DbSet<Sam3_ServTec_RequisicionJuntaSpool> Sam3_ServTec_RequisicionJuntaSpool { get; set; }
        public virtual DbSet<Sam3_ServTec_ValidacionResultados> Sam3_ServTec_ValidacionResultados { get; set; }
        public virtual DbSet<Sam3_TurnoLaboralProveedor> Sam3_TurnoLaboralProveedor { get; set; }
        ...
        public virtual ObjectResult<Sam3_Armado_Get_MaterialesSpool2_Result> Sam3_Armado_Get_MaterialesSpool2(Nullable<int> juntaSpoolID, Nullable<int> todos, Nullable<int> pagina)
        {
            var juntaSpoolIDParameter = juntaSpoolID.HasValue ?
                new ObjectParameter("JuntaSpoolID", juntaSpoolID) :
                new ObjectParameter("JuntaSpoolID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Armado_Get_MaterialesSpool2_Result>("Sam3_Armado_Get_MaterialesSpool2", juntaSpoolIDParameter, todosParameter, paginaParameter);
        }
        ...
        public virtual ObjectResult<Sam3_Cat_PQR_ListaCodigos_Result> Sam3_Cat_PQR_ListaCodigos(Nullable<int> pROYECTOID, Nullable<int> tIPOPRUEBA, string eSPECIFICACION, string cODIGO)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Cat_PQR_ListaCodigos_Result>("Sam3_Cat_PQR_ListaCodigos", pROYECTOIDParameter, tIPOPRUEBAParameter, eSPECIFICACIONParameter, cODIGOParameter);
        }
        ...
        public virtual ObjectResult<Sam3_Embarque_Get_Consulta_Result> Sam3_Embarque_Get_Consulta(string proyectoIDs, string patioIDS, Nullable<int> area, Nullable<int> cuadrante)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Embarque_Get_Consulta_Result>("Sam3_Embarque_Get_Consulta", proyectoIDsParameter, patioIDSParameter, areaParameter, cuadranteParameter);
        }
        ...
        public virtual ObjectResult<Sam3_Get_Areas_Proyecto_Patio_Result> Sam3_Get_Areas_Proyecto_Patio(string proyectoIDs, string patioIDS)
        {
            var proyectoIDsParameter = proyectoIDs != null ?
                new ObjectParameter("ProyectoIDs", proyectoIDs) :
                new ObjectParameter("ProyectoIDs", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Get_Areas_Proyecto_Patio_Result>("Sam3_Get_Areas_Proyecto_Patio", proyectoIDsParameter, patioIDSParameter);
        }
    
        public virtual ObjectResult<Sam3_Get_Cuadrante_Proyecto_Patio_Result> Sam3_Get_Cuadrante_Proyecto_Patio(string proyectoIDs, string patioIDS, Nullable<int> area)
        {
            var proyectoIDsParameter = proyectoIDs != null ?
                new ObjectParameter("ProyectoIDs", proyectoIDs) :
                new ObjectParameter("ProyectoIDs", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Get_Cuadrante_Proyecto_Patio_Result>("Sam3_Get_Cuadrante_Proyecto_Patio", proyectoIDsParameter, patioIDSParameter, areaParameter);
        }
        ...
        public virtual ObjectResult<Sam3_Inspeccion_Get_DetalleXJunta_Result> Sam3_Inspeccion_Get_DetalleXJunta(Nullable<int> ordenTrabajoSpoolID, string lenguaje, string juntaSpoolID)
        {
            var ordenTrabajoSpoolIDParameter = ordenTrabajoSpoolID.HasValue ?
                new ObjectParameter("OrdenTrabajoSpoolID", ordenTrabajoSpoolID) :
                new ObjectParameter("OrdenTrabajoSpoolID", typeof(int));
            ...
            var juntaSpoolIDParameter = juntaSpoolID != null ?
                new ObjectParameter("JuntaSpoolID", juntaSpoolID) :
                new ObjectParameter("JuntaSpoolID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Inspeccion_Get_DetalleXJunta_Result>("Sam3_Inspeccion_Get_DetalleXJunta", ordenTrabajoSpoolIDParameter, lenguajeParameter, juntaSpoolIDParameter);
        }
        ...
        public virtual ObjectResult<Sam3_Pintura_Get_SpoolCarroBackLog_Result> Sam3_Pintura_Get_SpoolCarroBackLog(Nullable<int> medioTransporteCargaID, Nullable<int> proyectoID)
        {
            var medioTransporteCargaIDParameter = medioTransporteCargaID.HasValue ?
                new ObjectParameter("MedioTransporteCargaID", medioTransporteCargaID) :
                new ObjectParameter("MedioTransporteCargaID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Pintura_Get_SpoolCarroBackLog_Result>("Sam3_Pintura_Get_SpoolCarroBackLog", medioTransporteCargaIDParameter, proyectoIDParameter);
        }
        ...
        public virtual ObjectResult<Sam3_ServiciosTecnicos_Get_JuntasXPrueba_Result> Sam3_ServiciosTecnicos_Get_JuntasXPrueba(Nullable<int> proyectoID, Nullable<int> todos, Nullable<int> requisicionID, string lenguaje)
        {
            var proyectoIDParameter = proyectoID.HasValue ?
                new ObjectParameter("ProyectoID", proyectoID) :
                new ObjectParameter("ProyectoID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_ServiciosTecnicos_Get_JuntasXPrueba_Result>("Sam3_ServiciosTecnicos_Get_JuntasXPrueba", proyectoIDParameter, todosParameter, requisicionIDParameter, lenguajeParameter);
        }
    
        public virtual ObjectResult<Sam3_ServiciosTecnicos_Get_JuntasXPruebaNuevo_Result> Sam3_ServiciosTecnicos_Get_JuntasXPruebaNuevo(Nullable<int> juntaTrabajoID, Nullable<int> proyectoID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_ServiciosTecnicos_Get_JuntasXPruebaNuevo_Result>("Sam3_ServiciosTecnicos_Get_JuntasXPruebaNuevo", juntaTrabajoIDParameter, proyectoIDParameter);
        }
        ...
        public virtual int Sam3_ServiciosTecnicos_Get_RequisicionDetalleValidacionResultados(string fOLIO, string lenguaje)
        {
            var fOLIOParameter = fOLIO != null ?
                new ObjectParameter("FOLIO", fOLIO) :
                new ObjectParameter("FOLIO", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sam3_ServiciosTecnicos_Get_RequisicionDetalleValidacionResultados", fOLIOParameter, lenguajeParameter);
        }
        ...
        public virtual int Sam3_ServiciosTecnicos_Requisicion(string lenguaje, Nullable<int> usuario, Nullable<int> requisicionID, string folio, Nullable<int> pruebaID, string fechaRequisicion, string observacion, Nullable<int> estatusID)
        {
            var lenguajeParameter = lenguaje != null ?
                new ObjectParameter("Lenguaje", lenguaje) :
                new ObjectParameter("Lenguaje", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sam3_ServiciosTecnicos_Requisicion", lenguajeParameter, usuarioParameter, requisicionIDParameter, folioParameter, pruebaIDParameter, fechaRequisicionParameter, observacionParameter, estatusIDParameter);
        }
        ...
        public virtual int Sam3_Soldadura_Set_PQR(Nullable<int> usuario)
        {
            var usuarioParameter = usuario.HasValue ?
                new ObjectParameter("Usuario", usuario) :
                new ObjectParameter("Usuario", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sam3_Soldadura_Set_PQR", usuarioParameter);
        }
        ...
        public virtual ObjectResult<Sam3_Steelgo_Get_Colada_Result> Sam3_Steelgo_Get_Colada(Nullable<int> proyectoID)
        {
            var proyectoIDParameter = proyectoID.HasValue ?
                new ObjectParameter("ProyectoID", proyectoID) :
                new ObjectParameter("ProyectoID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Steelgo_Get_Colada_Result>("Sam3_Steelgo_Get_Colada", proyectoIDParameter);
        }
        ...
        public virtual ObjectResult<Sam3_Steelgo_Get_Contactos_Result> Sam3_Steelgo_Get_Contactos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_Steelgo_Get_Contactos_Result>("Sam3_Steelgo_Get_Contactos");
        }
        ...
        public virtual ObjectResult<Sam3_SteelGo_Get_TipoPruebas_Result> Sam3_SteelGo_Get_TipoPruebas(string lenguaje)
        {
            var lenguajeParameter = lenguaje != null ?
                new ObjectParameter("Lenguaje", lenguaje) :
                new ObjectParameter("Lenguaje", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sam3_SteelGo_Get_TipoPruebas_Result>("Sam3_SteelGo_Get_TipoPruebas", lenguajeParameter);
        }
