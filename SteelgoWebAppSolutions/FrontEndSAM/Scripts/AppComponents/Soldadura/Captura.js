...
function CargarGridSoldadura() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            { field: "WPS", title: "WPS", filterable: getGridFilterableCellMaftec(), editor:RenderComboBoxWPS, width: "130px" },
            { field: "PQR", title: "PQR", filterable: getGridFilterableCellMaftec(), editor: RenderComboBoxPQR, width: "130px" },
