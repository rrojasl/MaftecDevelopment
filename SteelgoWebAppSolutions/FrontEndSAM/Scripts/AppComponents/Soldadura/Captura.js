...
function CargarGridSoldadura() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            { field: "Diametro", title: _dictionary.CapturaSoldaduraHeaderDiametro[$("#language").data("kendoDropDownList").value()], filterable: getGridFilterableCellMaftec(), width: "130px", attributes: { style: "text-align:right;" } },
            { field: "FechaSoldadura", title: _dictionary.CapturaSoldaduraHeaderFechaSoldadura[$("#language").data("kendoDropDownList").value()], filterable: getKendoGridFilterableDateMaftec(), editor: RenderDatePicker, width: "160px", format: _dictionary.FormatoFecha[$("#language").data("kendoDropDownList").value()] },
            ...
            { field: "WPSNombre", title: _dictionary.CapturaSoldaduraHeaderWPS[$("#language").data("kendoDropDownList").value()], editor: RenderComboBoxWPS, filterable: getGridFilterableCellMaftec(), width: "130px" },
...
function CargarGridPopUpRaiz() {
    ...
    $("#gridPopUp").kendoGrid({
        ...
        columns: [
          { field: "TrabajoAdicional", title: _dictionary.CapturaSoldaduraHeaderTrabajosAdicionalesAnidado[$("#language").data("kendoDropDownList").value()], filterable: getGridFilterableCellMaftecpopUp(), width: "100px", editor: RenderComboBoxSoldadoresRaiz },
