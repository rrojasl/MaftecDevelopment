...
function CargarGridSoldadura() {
    ...
    $("#grid").kendoGrid({ 
        ...
        columns: [ 
            ...
            { field: "FechaSoldadura", title: _dictionary.CapturaSoldaduraHeaderFechaSoldadura[$("#language").data("kendoDropDownList").value()], filterable: { cell: { showOperators: false } }, editor: RenderDatePicker, width: "130px", format: _dictionary.FormatoFecha[$("#language").data("kendoDropDownList").value()] },
