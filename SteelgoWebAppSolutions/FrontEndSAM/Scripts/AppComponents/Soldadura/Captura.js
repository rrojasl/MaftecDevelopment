...
function CargarGridSoldadura() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            { field: "Diametro", title: _dictionary.CapturaSoldaduraHeaderDiametro[$("#language").data("kendoDropDownList").value()], filterable: getGridFilterableCellMaftec(), width: "130px" },
