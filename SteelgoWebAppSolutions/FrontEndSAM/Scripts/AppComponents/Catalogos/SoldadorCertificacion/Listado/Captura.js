...
function CargarGrid() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            { field: "EspesorMinimo", title: _dictionary.SoldadorCertificacionEspesorMinimo[$("#language").data("kendoDropDownList").value()], filterable: getGridFilterableCellMaftec(), width: "120px", format: "{0:n4}", editor: renderEmin, attributes: { style: "text-align:right;" } },
            { field: "EspesorMaximo", title: _dictionary.SoldadorCertificacionEspesorMaximo[$("#language").data("kendoDropDownList").value()], filterable: getGridFilterableCellMaftec(), width: "120px", attributes: { style: "text-align:right;" }, format: "{0:n4}" },
