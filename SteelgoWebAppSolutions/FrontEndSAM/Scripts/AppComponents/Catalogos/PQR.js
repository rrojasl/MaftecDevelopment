...
function CargarGrid() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
                    ...
                    { command: { text: _dictionary.botonDetalle[$("#language").data("kendoDropDownList").value()], click: editarPQR }, title: " ", width: "50px" },
                    { command: { text: _dictionary.botonCancelar[$("#language").data("kendoDropDownList").value()], click: EliminarPQR }, title: " ", width: "50px" },
