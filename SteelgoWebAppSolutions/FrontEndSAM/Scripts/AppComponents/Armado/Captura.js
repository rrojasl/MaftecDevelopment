...
function CargarGrid() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            { field: "Diametro", title: _dictionary.CapturaArmadoHeaderDiametro[$("#language").data("kendoDropDownList").value()], filterable: getGridFilterableCellNumberMaftec(), width: "85px", format: "{0:n4}" },
            { field: "FechaArmado", title: _dictionary.CapturaArmadoHeaderFechaArmado[$("#language").data("kendoDropDownList").value()], filterable: { cell: { showOperators: false } }, editor: RenderDatePicker, width: "140px", format: _dictionary.FormatoFecha[$("#language").data("kendoDropDownList").value()] },
